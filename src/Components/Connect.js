    ...
    <div>
      {active && typeof account === "string" ? (
        <Popover className="relative">
          {({ open }) => (
            <>
              <Popover.Button className="flex flex-row items-center bg-fuchsia-900 text-slate-50 border border-fuchsia-900 outline-none px-6 py-2 hover:px-[1.625rem] hover:py-[0.625rem] font-poppins font-medium text-sm rounded-lg transition-all">
                <span>{formatAddress(account, 4)}</span>
                <ChevronDownIcon
                  className="ml-2 h-5 w-5 text-slate-50 transition duration-150 ease-in-out group-hover:text-opacity-80 hover:rotate-180"
                  aria-hidden="true"
                />
              </Popover.Button>
              <Transition
                  ...
                  <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    ...
                    <div className="flex justify-center bg-primary-black p-6">
                      <button
                        ...
                        className="bg-fuchsia-900 text-slate-50 outline-none px-8 py-2 font-poppins font-medium text-sm rounded-lg transition-all"
                      >
                        Disconnect Wallet
                      </button>
                    </div>
        ...
        <button
          ...
          className="bg-primary-black text-primary-green hover:bg-fuchsia-900 hover:text-primary-black border border-fuchsia-900 outline-none px-6 py-2 hover:px-[1.625rem] hover:py-[0.625rem] font-poppins font-medium text-sm rounded-lg transition-all"
        >
          Connect Wallet
        </button>
      )}
