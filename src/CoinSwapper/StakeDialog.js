      ...
      <Dialog as="div" className="relative z-10" onClose={close}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex items-center justify-center min-h-full p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md p-6 overflow-hidden text-left align-middle transition-all transform shadow-xl rounded-2xl bg-primary-gray">
                <Dialog.Title
                  as="h3"
                  className="text-lg font-bold leading-6 text-center text-primary-green"
                >
                  Select Token
                </Dialog.Title>
